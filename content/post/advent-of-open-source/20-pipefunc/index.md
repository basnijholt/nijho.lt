...
{{< figure src="image_2.png" caption="Example of a scheduled pipeline generated by PipeFunc" alt="A screenshot of a code editor showing Python code that uses the 'pipefunc' library to define and visualize a computational pipeline. On the right, a graph generated by 'pipeline.visualize()' is displayed, showing nodes and connections representing the pipeline's structure." >}}
