...
| **Command + Shift + E (Mac) / Ctrl + Shift + E (Windows)** |                                                            | Open the file explorer                                                                                                                                                  |
...
| **Command + I**                                            |                                                            | Open GitHub Copilot prompt inline                                                                                                                                       |
| **Command + Shift + I**                                    |                                                            | Open GitHub Copilot prompt in side bar                                                                                                                                  |
